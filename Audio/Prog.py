...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.ui = uic.loadUi("/Users/kamalboudjelaba/Desktop/Audio/interface.ui", self)
        self.resize(888, 600)
        ...
        self.downsample = 1  
        self.channels = [1]
        self.interval = 30  # mise à jour toutes les 30/1000 secondes
        ...
        self.timer.setInterval(self.interval)  # ms
